...
public class LinkedInTest {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//input[@id='username']")).sendKeys("egamefest@gmail.com");
        driver.findElement(By.xpath("//input[@id='password']")).sendKeys("Adnan321571@");
        driver.findElement(By.xpath("//button[@type='submit']")).click();
        driver.findElement(By.xpath("//button[@class=\"global-nav__primary-link artdeco-dropdown__trigger artdeco-dropdown__trigger--placement-bottom ember-view\"]")).click();
